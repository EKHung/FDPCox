...
# Breslow estimator at covariates=0
...
# run the CDP versions of the experiment, using full data
...
save(real_coefs, real_breslow, real_CDPcoefs, real_CDPbreslow, 
     file='real_experiments.RData')
